package com.dhy.xintent.utils;


/**
 * A unit of information using SI and IEC prefixes.
 *
 * @author https://github.com/dropwizard/dropwizard/blob/master/dropwizard-util/src/main/java/io/dropwizard/util/DataSizeUnit.java
