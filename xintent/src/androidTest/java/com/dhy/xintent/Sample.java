...
public class Sample extends Activity {
	...
	public void normalSetMethod(String a, boolean b, int c, DataSerializable d) {
	...
	void normalGetMethod() {
		...
		DataSerializable d = (DataSerializable) intent.getSerializableExtra(KEY_MSG_d);
	}
	//endregion

	//region 用XIntent(com.dhy.xintent.XIntent extends Intent)可以简化如下

	public void XIntentSetMethod(String a, boolean b, int c, DataSerializable d) {
		XIntent.Companion.startActivity(this, MainActivity.class, a, b, c, d);
	}

	public void XIntentSetMethod2(String a, boolean b, int c, DataSerializable d) {
	...
	void XIntentGetMethod() {
		...
		DataSerializable d = XIntent.Companion.readSerializableExtra(this, DataSerializable.class);
	}

	//endregion

	//region 也可以直接操作Intent
	public void XIntentSetResult(String a, boolean b, int c, DataSerializable d) {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		DataSerializable d = XIntent.Companion.readSerializableExtra(data, DataSerializable.class);
	}
	//endregion
}
